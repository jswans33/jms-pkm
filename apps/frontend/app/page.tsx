...
const FEATURE_STEPS: ReadonlyArray<FeatureStep> = [
  {
    description: "Get started by editing",
    highlight: "app/page.tsx",
  },
  {
...
const RESOURCE_LINKS: ReadonlyArray<ResourceLink> = [
  {
  ...
  <footer className="row-start-3 flex gap-[24px] flex-wrap items-center justify-center">
    {RESOURCE_LINKS.map((link) => (
      <a
        ...
        rel="noopener noreferrer"
      >
        <Image aria-hidden src={link.icon} alt={`${link.label} icon`} width={16} height={16} />
        {link.label}
      </a>
    ))}
  </footer>
